...
$args = array(
	...
	'menu_title'           => esc_html__( 'Theme Options', 'loobek' ),
	'page_title'           => esc_html__( 'Theme Options', 'loobek' ),
	...
	'global_variable'      => 'loobek_theme_options',
...
$args['share_icons'][] = array(
	...
	'title' => esc_html__('Like us on Facebook', 'loobek'),
	'icon' => 'el el-facebook'
);
...
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'General', 'loobek' )
	,'id'               => 'general-tab'
	,'desc'             => ''
	,'icon'             => 'el el-home'
...
/*** Color Scheme Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Color Scheme', 'loobek' )
	,'id'               => 'color-scheme-tab'
	,'desc'             => ''
	,'icon'             => 'el el-brush'
...
/*** Typography Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Typography', 'loobek' )
	,'id'               => 'typography-tab'
	,'desc'             => ''
	,'icon'             => 'el el-font'
...
/*** Header Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Header', 'loobek' )
	,'id'               => 'header-tab'
	,'desc'             => ''
	,'icon'             => 'el el-lines'
...
/*** Footer Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Footer', 'loobek' )
	,'id'               => 'footer-tab'
	,'desc'             => ''
	,'icon'             => 'el el-lines'
...
/*** WooCommerce Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'WooCommerce', 'loobek' )
	,'id'               => 'woocommerce-tab'
	,'desc'             => ''
...
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Shop/Product Category', 'loobek' )
...
/*** Product Details Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Product Details', 'loobek' )
...
/*** Custom Code Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Custom Code', 'loobek' )
	,'id'               => 'custom-code-tab'
	,'desc'             => ''
	,'icon'             => 'el el-edit'
