...
HTML;
    ...
    private function create_store_locations_settings_fields()
    {
        ...
        $lpac_settings[] = array(
            ...
            'desc'                   => sprintf(
            __( 'Create your different store locations. A "store" in this context simply means the locations where you do business. Separate latitude and longitude coordinates with a comma. You can use a website like %1$sthis one%2$s to get the GPS coordinates for an address. %3$s', 'map-location-picker-at-checkout-for-woocommerce' ),
            "<a href='https://gps-coordinates.org/' target='_blank'>",
            "<span style='text-decoration: none' class='dashicons dashicons-external'></span></a>",
            "<a href='https://lpacwp.com/docs/store-locations/?utm_source=storelocationstab&utm_medium=lpacdashboard&utm_campaign=freedocs' target='blank'>" . self::$learn_more . '</a>'
        ),
        ...
        $lpac_settings[] = array(
            ...
            '<code>',
            '</code>',
            '<a href="https://lpacwp.com/docs/store-locations/?utm_source=storelocationstab&utm_medium=lpacdashboard&utm_campaign=freedocs#shortcode" target="_blank">' . self::$learn_more . '</a>'
        ),
            'type'      => 'info_text',
            'is_option' => false,
        );
