	...
	private function output_map_visibility_rules_order() {
		...
		<div>
			<table id="lpac-rules" class='wc-shipping-zones'>
				<h4><?php echo $info_text //phpcs:ignore -- Already escaped above; ?></h4>
	...
	public function create_plugin_settings_fields() {
		...
		if ( $current_section === 'export' ) {
			...
			if ( lpac_fs()->can_use_premium_code__premium_only() ) {
				...
				// Setup our map view
				$admin_settings_controller = new \Lpac\Pro\Controllers\Admin_Settings_Controller();
				$admin_settings_controller->setup_export_settings_mapOptions();
			}
		}
		...
		if ( $current_section === 'shipping' ) {
			...
			if ( lpac_fs()->can_use_premium_code__premium_only() ) {
				...
				// Setup our map view
				$admin_settings_controller = new \Lpac\Pro\Controllers\Admin_Settings_Controller();
				$admin_settings_controller->setup_shipping_settings_mapOptions();
			}
		}
