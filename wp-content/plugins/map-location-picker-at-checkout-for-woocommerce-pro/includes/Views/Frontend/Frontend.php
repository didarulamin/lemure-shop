...
JAVASCRIPT;
	...
	public function lpac_output_map_on_order_details_page() {
		...
		<div id="lpac-map-container" class='woocommerce-shipping-fields__field-wrapper'>
			...
			<h2 class='woocommerce-order-details__title'><?php echo esc_html( $label ); ?></h2>
			<div class='lpac-map'></div>
	...
	public function create_checkoutpage_translated_strings() {
		...
		$strings = array(
			...
			'generic_last_order_address' => apply_filters( 'lpac_empty_last_order_address_default_text', __( 'Previous Address', 'map-location-picker-at-checkout-for-woocommerce' ) ), // This is used if no address exists in the customer's last order
		);
